...
func Test_generateURLUsesConfiguredLocale(t *testing.T) {
	f := fetcher{
		params: fetchReviewsParams{
			mapURL:     "https://www.google.com/maps/place/Foo/data=!4m7!3m6!1s0x89c259ab3c1ef289:0x3b67a41175949f55",
			langCode:   "vi",
			regionCode: "VN",
		},
	}

	got, err := f.generateURL(f.params.mapURL, "", 20, "request-id")
	if err != nil {
		t.Fatalf("generateURL() error = %v", err)
	}

	assert.Contains(t, got, "hl=vi")
	assert.Contains(t, got, "gl=VN")
}
