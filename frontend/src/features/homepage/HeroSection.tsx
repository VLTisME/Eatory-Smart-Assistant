...
const HERO_TEXT = {
	vi: {
		...
		desc: "Khám phá thế giới qua những hương vị khó quên cùng các hành trình ẩm thực được thiết kế riêng cho mọi tín đồ ăn uống.",
		searching: "Đang tìm...",
		search: "Tìm kiếm",
	},
	en: {
		...
		adventure: "ADVENTURE",
		desc: "Explore the world one flavor at a time with bespoke culinary adventures designed for every food enthusiast.",
		searching: "Searching...",
		search: "Search",
	},
};
